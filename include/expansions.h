...
/*   Updated: 2023/03/09 01:41:34 by vfries           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
ssize_t			add_expression(char *arg, char *delimiters,
					t_list **expansions);
...
int				replace_parameters(t_list **expansions,
...
//	arguments.c
int				apply_arguments_expansion(t_token *token,
					t_hashmap env_variables);
...
//	utils.c
int				add_back_expansion_node(char *content, int type,
					t_list **expansions);
int				add_front_expansion_node(char *content, int type,
					t_list **expansions);
